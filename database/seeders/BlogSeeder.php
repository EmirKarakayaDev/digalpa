...
class BlogSeeder extends Seeder
{
    ...
    {
        // Brief §07: 4 içerik kategorisi — 1. Uygulama rehberleri 2. Ürün karşılaştırmaları
        // 3. Sık sorulan sorular 4. AKEMI/marka içeriği. Kategori adları brief'in taksonomisiyle
        // birebir eşleşiyor, serbest/genel isimler kullanılmıyor.
        $categories = [
            ['name' => 'Uygulama Rehberleri',        'slug' => 'uygulama-rehberleri',        'sort_order' => 1],
            ['name' => 'Ürün Karşılaştırmaları',      'slug' => 'urun-karsilastirmalari',     'sort_order' => 2],
            ['name' => 'Sık Sorulan Sorular',         'slug' => 'sik-sorulan-sorular',        'sort_order' => 3],
            ['name' => 'AKEMI & Marka İçerikleri',    'slug' => 'akemi-marka-icerikleri',     'sort_order' => 4],
        ];
        ...
        $rehber = BlogCategory::where('slug', 'uygulama-rehberleri')->first();
        $kars   = BlogCategory::where('slug', 'urun-karsilastirmalari')->first();
        $sss    = BlogCategory::where('slug', 'sik-sorulan-sorular')->first();
        $akemi  = BlogCategory::where('slug', 'akemi-marka-icerikleri')->first();
