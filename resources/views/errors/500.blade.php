...
<head>
    ...
    <title>Sunucu Hatası — Digalpa</title>
    ...
    <main class="flex-1 flex items-center justify-center px-6 py-20">
        <div class="text-center max-w-md">
            ...
            <div class="font-serif text-[120px] leading-none font-semibold mb-2"
                 style="color: var(--color-navy-10);">500</div>

            <div class="label-caps mb-4" style="color: var(--color-navy-40);">Sunucu Hatası</div>
            ...
            <p class="text-gray-500 leading-relaxed mb-8">
                Sunucumuzda beklenmedik bir hata oluştu. Ekibimiz bilgilendirildi,
                kısa süre içinde düzeltilecek.
            </p>
